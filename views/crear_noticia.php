...
<body>
    ...
    $descripcion = filter_input(INPUT_GET, 'descri', FILTER_SANITIZE_FULL_SPECIAL_CHARS); 

    $text_er_1 = "Título obligatorio.";
    $text_er_2 = "Campo obligatorio.";
    ...
    <main>
        ...
        <form id="formulario_noti" name="formulario_noti" class="formulario_notu" method="POST" action="../admin/control_admin/control_admin_noticia.php" enctype="multipart/form-data">
                <fieldset id="grupo_datos">
                    ...
                    <table class="conte_table">
                        <tr class="conte_tr">
                            <td class="conte_td"></td>
                            <td class="conte_td"></td>
                        </tr>
                        <tr class="conte_tr">
                            <td class="conte_td"><label class="conte_input" for="titulo">Titulo de la noticia</label></td>
                            <td class="conte_td"><input class="conte_input"type="text" id="titulo" value="<?php echo ($titulo == 1 || $titulo == 2) ? "" : $titulo ?>" name="titulo">
                            <br>
                            <span class="error">
                            <small>
                                <?php                                    
                        ...
                        <tr class="conte_tr ">
                            <td class="conte_td"><label class="conte_input" for="imagen">Imagen de la noticia</label></td>
                            <td class="conte_td"><input class="conte_input borde" type="file" size="20" name="imagen" id="imagen">                          
                        ...
                        <tr class="conte_tr">
                            <td class="conte_td"><label class="conte_input" for="descripcion"></label>Descripción </td>                       
                       
                            <td class="conte_td">
                                <textarea class="conte_input" name="descripcion" id="descripcion" cols="40" rows="10"><?php echo ($descripcion == 1) ? "" : $descripcion ?></textarea>
                                <br>
                                <span class="error">
                                <small>
                                    <?php
                                        echo ($descripcion == 1) ? $text_er_2 : "";
                                    ?>
                                </small>
                                </span>
                            </td>                            
                ...
                <div class="subir_noticias">
                    <button type="submit" name="subir_noticia" class="solicitar_cita" id="boton_log">Guardar noticia</button>
                </div>
            </form>                             
        </div>
    </main>
