...
<body>
    ...
    <main>
        <div class="contenedor_main">
            <form id="formulario_reg" name="formulario_reg" class="formulario_reg" method="POST" action="../admin/control_admin/insert_admin.php">
                ...
                <br>                               
                <button type="submit" name="enviar_registro" class="solicitar_cita" id="boton_enviar">Enviar registro</button>
                <br>
            </form>
        </div>
    </main>
