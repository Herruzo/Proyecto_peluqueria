...
<body>
    ...
    <main>
        <div class="contenedor_main">
            <div>
                <h3><center>Entra dentro de un usuario para solicitar la cita.</center></h3>
            </div>
            <br>
            <div class="mostrar_user">
               <table>
                ...
                while($fila = $ver_user->fetch(PDO::FETCH_ASSOC)){
                    ...
                    echo '<tr class="borde">
                    <td class ="borde"><center>'.$fila['usuario'].'</center></td>
                    ...
                    <td><a href="./admin_solicita_cita.php?id='.$fila['idUser'].'"><img class="ico_entrar" src="../assets/images/entrar_1_c.png" title="Entrar" alt="entrar_en_el_usuario"></a></td>
                    </tr>';                    
                    }
