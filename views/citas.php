    ...
    ?>
            ...
            <nav id="nav_menu" class="nav_menu">
                <div id="nav_links_registro" class="nav_links_registro">
                    <div class="nav-links comun">
                        ...
                        <a class="link-item" href="#" id="op1">Citas</a>
                        <a class="link-item" href="../admin/control/consulta_perfil_user.php"><img class="perfil" src="../assets/images/perfil_2.png" alt="imagen_perfil">
                            <?php print $_SESSION['nombre'];?>
                        </a>
        ...
        <main>
            <div class="contenedor_main">
                <form id="formulario_cita" name="formulario_cita" class="formulario_cita" method="POST" action="../admin/control/control_cita.php">
                    <fieldset>
                        <legend>
                            <h3>&nbsp;Citas&nbsp;</h3>
                        </legend>
                        <table>
                            <tr class="position_input tr_form">
                                ...
                                <td class="td_form"><input class="inp_form" type="text" name="dia" id="dia" value="<?php echo $fecha ?>" placeholder="Días disponibles" required readonly>
                                    <br>
                                    <span class="error">
                                        <small>
                                            <?php
            ...
            <div class="contenedor_main" >
                <h2 class="tus_citas">Tus citas</h2>
                <div class="contenedor_main" id="tabla_cita">
                <table class="cont_citas">
                
                        <tr class="borde">
                        <th ></th>
                        <th class="borde"><h3>Día de la cita</h3></th>
                        <th class="borde"><h3>Hora de la cita</h3></th>
                    ...
                    <?php
                        ...
                        while($fila = $consulta_cita->fetch(PDO::FETCH_ASSOC)){                            
                            ...
                            <td class="td_borrar"><a href="../admin/control/control_modificar_cita.php?fecha='.$fila['fecha_cita'].'&hora='.$fila['hora_cita'].'&servicio='.$fila['servicio'].'&iD='.$fila["idCita"].'"><img class="ico_editar" src="../assets/images/editar_3_c.png" title="Modificar" alt="editar"></a></td>

                            <td class="td_borrar"><a href="../admin/control/baja_cita.php?iD='.$fila['idCita'].'"><img class="ico_borrar" src="../assets/images/borrar_1_c.png" title="Eliminar" alt="eliminar"></a></td>
