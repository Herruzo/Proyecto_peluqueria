...
<body>
    ...
    if (!isset($_SESSION['usuario']) || ($_SESSION['usuario'] != 'admin')) {
        ...
        if(!$nombre){
            header('location: ../admin/control/consulta_perfil_admin.php');
        }    
    ...
    <div class="contenedor_main">
        <div class="contenedor_main">         
            <form action="../admin/control/modificar_perfil_admin.php" method="POST" id="perfil" name="perfil" class="perfil" >
                <fieldset id= "grupo_datos">
                    <legend id="legend_datos">
                        <h3>&nbsp; Estos son tus datos <?php echo $_SESSION['nombre']?> &nbsp;</h3>
                    </legend>
                    <table>
                        <tr class="position_input">
                            <td><label for="nombre">Nombre: </label></td>
                            <td><input type="text" name="nombre" id="nombre" value="<?php echo ($nombre == 1) ? "" : $nombre?>"> <br>
                        ...
                        <tr class="position_input">
                            ...
                            <td><input type="text" name="apellidos" id="apellidos" value="<?php echo ($apellidos == 1) ? "" : $apellidos?>"> <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                        <?php
                        ...
                        <tr class="position_input">
                            ...
                            <td><input type="text" name="direccion" id="direccion" value="<?php echo ($direccion == 1) ? "" : $direccion  ?>" > <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                        <?php
                        ...
                        <tr class="position_input">
                            ...
                            <td><input type="text" name="poblacion" id="poblacion" value="<?php echo ($poblacion == 1) ? "" : $poblacion ?>" > <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                        <?php
                        ...
                        <tr class="position_input">
                            ...
                            <td><input type="text" name="provincia" id="provincia" value="<?php echo ($provincia == 1) ? "" : $provincia?>" > <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                        <?php
                        ...
                        <tr class="position_input">
                            ...
                            <td><input type="number" name="codigo_postal" id="cp" value="<?php echo ($cp == 1)?"" : $cp?>" > <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                        <?php
                        ...
                        <tr class="position_input">
                            ...
                            <td><input type="tel" name="telefono" id="telefono" value="<?php echo ($tel == 1)?"" : $tel ?>" > <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                        <?php
                        ...
                        <tr class="position_input">
                            ...
                            <td><input type="email" name="email" id="email" value="<?php echo ($email == 1 || $email == 2) ? "" : $email ?>" > <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                    <?php
                        ...
                        <tr class="position_input">
                            <td><label for="fecha_nac">Fecha de nacimiento: </label></td>
                            <td><input type="date" name="fecha_nac" id="fecha_nac" value="<?php echo ($fecha_nac == 1) ? "" : $fecha_nac  ?>"> <br>
                                <small>Error mensaje</small>
                                <span class="error">
                                    <small>
                                        <?php
                ...
                <fieldset>
                    ...
                    <table>                        
                        ...
                        <tr class="position_input">
                            <td><label for="pass_rep">Repetir contraseña: </label></td>
                            <td><input type="password" name="pass_rep" id="pass_rep" >
                                <span class="ver" id="ver_pass_rep"><img class="ico_ver" src="../assets/images/ojo.png" alt="ver password"></span> <br>
                                <small>Error mensaje</small>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="botones">
                    ...
                    <a href="#"><button type="button" name="baja" class="boton_ir_registro loging" id="baja_admin">Darse de baja</button></a>
                </div>
            </form>
        </div>
    </div>
